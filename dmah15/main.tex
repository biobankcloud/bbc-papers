...
\begin{abstract}
Biobanks store and catalog human biological material that is increasingly being digitized using technologies such as whole genome sequencing. There is, however, a Biobank bottleneck: existing software systems are not scalable and secure enough to store and process the coming wave of genomic data from Next-Generation Sequencing machines. In the BiobankCloud project, we are building an open-source Hadoop-based platform for the secure storage, sharing, and parallel processing of genomic data. We have extended Hadoop to include support for multi-tenant studies, reduced data sizes with erasure coding, support for extensible and consistent metadata. On top of Hadoop, we have built a scalable scientific workflow framework and support secure sharing of data across Hadoop clusters. Finally, we provide user-friendly access to the BiobankCloud services in a Laboratory Information Managmenent System with support for 2-factor authentication.
\end{abstract}
